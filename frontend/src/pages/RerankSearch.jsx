...
export default function RerankSearch() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      <div>
        <h1 className="text-xl font-bold tracking-tight text-main">Rerank Search</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            <CustomSelect
              ...
              options={[
                { value: 3, label: 'Top 3 Reranked' },
                { value: 5, label: 'Top 5 Reranked' },
                { value: 10, label: 'Top 10 Reranked' },
              ]}
              size="sm"
            />
